...
class DataProcessing:
    ...
    def get_class_weights():
        ...
        num_per_class = np.array([55169708, 319432, 539497, 2565023, 3256258, 550349, 183274, 78886, 
                                    239228873, 17119887, 168787641, 6327051, 227988164, 100538808, 470826468, 
                                    9782368, 128156486, 4452688, 1163835])
